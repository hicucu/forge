...
#   $OPENCODE_CONFIG_DIR/forge/             ← package root
#   $OPENCODE_CONFIG_DIR/forge/skills/      ← skills dir (../../skills from plugin)
#   $OPENCODE_CONFIG_DIR/forge/.opencode/plugins/forge.js ← plugin file
#   $OPENCODE_CONFIG_DIR/plugins/forge.js   ← symlink OpenCode reads

FORGE_DIR="$OPENCODE_CONFIG_DIR/forge"
FORGE_SKILLS_DIR="$FORGE_DIR/skills"
FORGE_PLUGIN_FILE="$FORGE_DIR/.opencode/plugins/forge.js"
...
cp "$REPO_ROOT/.opencode/plugins/forge.js" "$FORGE_PLUGIN_FILE"

# Register plugin via symlink (what OpenCode actually reads)
mkdir -p "$OPENCODE_CONFIG_DIR/plugins"
ln -sf "$FORGE_PLUGIN_FILE" "$OPENCODE_CONFIG_DIR/plugins/forge.js"
...
echo "Plugin registered at: $OPENCODE_CONFIG_DIR/plugins/forge.js"
