...
대상 디렉토리의 기술 스택을 마커 파일 기반으로 감지하여 `stack-profile.json` 결과를 산출한다.
...
`{팀_위치}/agents/feature-planner.agent.md`를 읽고 "Phase 1.0 — 스택 감지 매트릭스" 섹션의 절차만 수행한다.
...
- 매트릭스 정의: `feature-planner.agent.md` "Phase 1.0 — 스택 감지 매트릭스" 섹션 (진실의 원천)
