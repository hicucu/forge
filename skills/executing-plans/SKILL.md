...
**시작 시 공지:** "executing-plans 스킬을 사용하여 이 플랜을 구현합니다."

**참고:** subagent 접근 권한이 있을 때 forge가 훨씬 더 잘 작동한다는 점을 사용자에게 알릴 것. subagent를 지원하는 플랫폼(Claude Code 또는 Codex 등)에서 실행하면 작업 품질이 현저히 높아짐. subagent를 사용할 수 있다면 이 스킬 대신 forge:subagent-driven-development를 사용할 것.
...
- 공지: "finishing-a-development-branch 스킬을 사용하여 이 작업을 완료합니다."
- **필수 서브 스킬:** forge:finishing-a-development-branch 사용
...
- **forge:using-git-worktrees** — 격리된 작업 공간 확보 (생성 또는 기존 환경 확인)
- **forge:writing-plans** — 이 스킬이 실행할 플랜 생성
- **forge:finishing-a-development-branch** — 모든 작업 완료 후 개발 마무리
