...
**시작 시 공지:** "finishing-a-development-branch 스킬을 사용하여 이 작업을 완료합니다."
...
**worktree 경로가 `.worktrees/`, `worktrees/`, 또는 `~/.config/forge/worktrees/` 아래인 경우:** forge가 이 worktree를 생성했으므로 정리를 담당.
...
- **해결:** `.worktrees/`, `worktrees/`, 또는 `~/.config/forge/worktrees/` 아래의 worktree만 정리
