...
문제가 연쇄되기 전에 잡아내기 위해 코드 리뷰어 subagent를 파견하라. 리뷰어는 평가를 위해 정밀하게 작성된 컨텍스트를 받는다 — 절대 현재 세션의 히스토리가 아니다. 이렇게 하면 리뷰어가 사고 과정이 아닌 작업 결과물에 집중하게 되고, 지속적인 작업을 위한 자신의 컨텍스트도 보존된다.
