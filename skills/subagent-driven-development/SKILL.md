...
digraph process {
    ...
    "forge:finishing-a-development-branch 사용" [shape=box style=filled fillcolor=lightgreen];
    ...
    "전체 구현에 대한 최종 코드 검토자 배포" -> "forge:finishing-a-development-branch 사용";
}
```
...
템플릿은 forge:writing-plans의 "HANDOFF.md — 세션 인계 안내" 참조.
