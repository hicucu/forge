...
- **forge:using-git-worktrees** — 격리된 작업 공간 보장 (생성 또는 기존 것 검증)
- **forge:writing-plans** — 이 skill이 실행할 플랜 생성
- **forge:requesting-code-review** — 검토자 서브에이전트용 코드 검토 템플릿
- **forge:finishing-a-development-branch** — 모든 작업 완료 후 개발 마무리

**서브에이전트가 사용해야 할 것:**

- **forge:test-driven-development** — 서브에이전트가 각 작업에 TDD 적용

**대안 워크플로우:**

- **forge:executing-plans** — 동일 세션 실행 대신 병렬 세션에 사용
