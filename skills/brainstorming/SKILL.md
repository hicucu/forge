---
name: brainstorming
description: "기능 생성·컴포넌트 구축·기능 추가·동작 수정 등 모든 창의적 작업 전에 반드시 사용. 구현 전 사용자 의도·요구사항·설계를 탐색."
---
...
> "스펙을 `<경로>`에 작성하고 커밋했습니다. 검토해 보시고 구현 계획 작성을 시작하기 전에 변경하고 싶은 부분이 있으면 알려주세요."
