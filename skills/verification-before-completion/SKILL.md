...
description: 작업이 완료·수정·통과됐다고 주장하기 직전, 커밋이나 PR 생성 전에 사용 - 성공 주장 전 검증 명령 실행과 출력 확인을 요구; 항상 주장보다 증거 우선
---
...
검증하지 않고 작업이 끝났다고 주장하는 것은 효율적인 게 아니라 부정직한 것이다.
...
- 위반 사항: "정직은 핵심 가치다. 거짓말하면 교체될 것이다."
