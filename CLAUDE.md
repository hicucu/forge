...
작업을 시작하기 전에 이 섹션을 완독하십시오.

이 저장소는 개인 전용 프로젝트입니다. 외부 PR을 받지 않으며, 모든 변경은 사용자(소유자)와 AI 에이전트 간의 협업으로만 이루어집니다.

**에이전트의 역할은 사용자를 실수로부터 보호하는 것입니다.** 검증되지 않은 변경, 범위를 벗어난 수정, 되돌릴 수 없는 작업은 도움이 아니라 피해입니다.

---

## 작업 전 필수 확인 사항

변경을 시작하기 전에 다음을 반드시 수행합니다:
...
skills는 단순한 문서가 아니라 에이전트 동작을 형성하는 코드입니다.
...
| plugin 관련 코드 추가           | 이 프로젝트는 plugin 미사용 |

---

## 참고

- 원본 프로젝트: [Superpowers](https://github.com/obra/superpowers)
