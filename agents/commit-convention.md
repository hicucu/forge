...
프로젝트의 커밋 메시지 규칙을 체계적으로 정리한 `COMMIT_CONVENTION.md`를 작성한다. 입력 참조가 주어지면 그 컨텍스트를 우선 반영하고, 없으면 Conventional Commits 표준을 기반으로 작성한다.
...
아래 순서로 `COMMIT_CONVENTION.md`를 작성한다:
...
프로젝트에 실제 사용되거나 표준적으로 권장되는 type을 명시한다:
